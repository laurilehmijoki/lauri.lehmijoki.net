---
layout: default
title: Getting VIM right in Mac
---
# {{ page.title }}

Opening a brand new MacBook is a pleasant experience. There are, however, a few tunings I do on my Mac, before I start feeling comfortable with it. At first I get my shell configurations from GitHub and then I compile VIM, because the default VIM in OS X Lion is compiled without Ruby support.
...
* Enjoy Ruby syntax awareness (highlighting, proper indentation of code)

The information in this article is also applicable to other \*nix systems than OS X.
...
`./configure --enable-rubyinterp -prefix=/usr`
